...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_CAPS] = ACTION_TAP_DANCE_DOUBLE(KC_DEL, KC_CAPS), //activate the tab with double press
};

//custom keycodes
#define CC_CPY TD(TD_CPY) // Copy with tap dance
#define CC_PTE TD(TD_PTE) // paste with tap dance
#define CC_FND TD(TD_FND) // find with tap dance
#define CC_UND TD(TD_UND) // undo with tap dance
#define CC_MINS TD(TD_MINS) // minus with tap dance
#define CC_EQL TD(TD_EQL) // equal with tap dance
#define CC_CAPS TD(TD_CAPS) // tab with tap dance
...
//      Ct_L     Win_L    Alt_L                                SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,      KC_F11,      KC_F12,     LSG(KC_S),        KC_MUTE,
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,        CC_MINS,     CC_EQL,     KC_BSPC,          KC_DEL,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,        KC_LBRC,     KC_RBRC,    KC_BSLS,          LWIN(KC_LEFT),
        CC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     KC_H,    KC_J,    KC_K,    KC_L,    TD(TD_SCLN), TD(TD_QUOT),             KC_ENT,           LWIN(KC_RGHT),
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,      TD(TD_SLSH),             KC_RSFT, KC_UP,   TD(TD_END),
        KC_LCTL, KC_LGUI, KC_LALT,                             KC_SPC,                             KC_RALT,     MO(1),       KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [1] = LAYOUT(
        _______,   KC_CALC,  KC_MYCM, KC_MSEL, KC_MAIL, KC_WSCH, _______, _______, _______, _______, _______, KC_WAKE, KC_SLEP, KC_PAUS,         _______,
        ...
        _______,   RGB_RMOD, RGB_VAD,  RGB_MOD, RGB_SPI, _______, _______, _______, _______, _______, _______, _______,           _______,          KC_BRID,
        _______,   QMKBEST,  _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______,                    _______, KC_MPLY, KC_PWR,
    ...
    case QMKBEST:
      if (record->event.pressed) { // when keycode QMKBEST is pressed
          SEND_STRING("Zxwe5634!");
            ...
            // when keycode QMKBEST key is released
        }
        break;
  }
 return true;
...
static void set_rgb_caps_leds_on() {
        ...
        rgb_matrix_set_color(70, 255, 0, 0);    //Left LED 02
        rgb_matrix_set_color(71, 255, 0, 0);    //Right LED 13
        rgb_matrix_set_color(73, 255, 0, 0);    //Left LED 03
        rgb_matrix_set_color(74, 255, 0, 0);    //Right LED 14
        rgb_matrix_set_color(76, 255, 0, 0);      //Left LED 04
        rgb_matrix_set_color(77, 255, 0, 0);      //Right LED 15
        rgb_matrix_set_color(80, 255, 0, 0);      //Left LED 05
        rgb_matrix_set_color(81, 255, 0, 0);      //Right LED 16
        rgb_matrix_set_color(83, 255, 0, 0);     //Left LED 06
        rgb_matrix_set_color(84, 255, 0, 0);     //Right LED 17
        rgb_matrix_set_color(87, 255, 0, 0);    //Left LED 07
        rgb_matrix_set_color(88, 255, 0, 0);    //Right LED 18
        rgb_matrix_set_color(91, 255, 0, 0);  //Left LED 08
        rgb_matrix_set_color(92, 255, 0, 0);  //Right LED 19
}
